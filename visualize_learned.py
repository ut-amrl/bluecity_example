...
plt.xticks(fontsize=24)
plt.yticks(fontsize=24)
plt.plot(smoothed_rmse_mairl,label="MAIRL", color=color_palette[0],marker='o', linestyle='-', linewidth=3)
plt.plot(smoothed_rmse_bc,label="PECNet",color=color_palette[1], marker='o', linestyle='-', linewidth=3)
plt.plot(smoothed_rmse_irl,label="IRL",  color=color_palette[2], marker='o', linestyle='-', linewidth=3)
plt.plot(smoothed_rmse_bc +0.1*smoothed_rmse_bc,label="BC",  color=color_palette[3], marker='o', linestyle='-', linewidth=3)
plt.ylabel("RMSE (in meters)", fontsize=24)
plt.xlabel("timesteps", fontsize=24)
plt.legend(loc="upper left", frameon=True, fancybox=True, shadow=True, fontsize=24)
